...
$pdfOutputPath = '/home/s1111442/public_html/HW2/donation_form.pdf'; // 设置保存的完整路径
$pdf->Output($pdfOutputPath, 'F'); // // 保存 PDF 到伺服器 ('F' 代表存儲)

require '/home/s1111442/vendor/autoload.php';
use Endroid\QrCode\QrCode;
use Endroid\QrCode\Writer\PngWriter;

$qrCode = new QrCode('http://140.138.155.243/~s1111442/HW2/donation_form.pdf'); // 使用 PDF 文件的 URL 生成 QR Code
$qrCode->setSize(300);
$qrCode->setMargin(10);

$qrCodeImage = '/home/s1111442/public_html/HW2/qrcode.png'; // 定义 QR Code 图像路径
$writer = new PngWriter();
$writer->write($qrCode)->saveToFile($qrCodeImage); // 保存 QR Code 图片

$pdf->Output('donation_form.pdf', 'I');
/*---------------- Sent Mail Start -----------------*/
...
try {
	...
	$mail->Body = "
        ...
        <p>感謝您的支持！</p>
    ";
	$mail->addAttachment($qrCodeImage); // 附加QR Code
